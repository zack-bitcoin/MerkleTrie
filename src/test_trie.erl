...
test5(CFG) ->
    ...
    <<L2:40>> = <<0,16,0,0,0>>,
    <<L3:40>> = <<0,1,0,0,0>>,
    Leaf1 = leaf:new(L1, V1, CFG),
    Leaf2 = leaf:new(L2, V2, CFG),
    Leaf3 = leaf:new(L3, V3, CFG),
    Leaf4 = leaf:new(L3, V1, CFG),

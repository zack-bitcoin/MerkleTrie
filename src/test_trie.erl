...
test1(CFG) ->
    ...
    Weight = 0,
    <<Laa:40>> = Lflip,
    LeafAB = leaf:new(Laa, Weight, Lb, CFG), 
...
test5(CFG) ->
    ...
    Leaf2 = leaf:new(L2, Weight, V2, CFG),
    Leaf3 = leaf:new(L3, Weight, V3, CFG),
    Leaf4 = leaf:new(L3, Weight, V1, CFG),
...
test6(CFG) ->
    ...
    Leafb = leaf:new(L2, Weight, V2, CFG),
    ...
    Leafc = leaf:new(L2, Weight, V3, CFG),
